...
- docs sviluppo/ai/00-project-context.md
- docs sviluppo/ai/01-non-regression-rules.md
- docs sviluppo/ai/02-target-architecture.md
- docs sviluppo/ai/03-implementation-plan.md
- docs sviluppo/ai/04-manual-test-checklist.md
